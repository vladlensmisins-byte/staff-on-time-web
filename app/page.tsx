  ...
  useEffect(() => {
    const TR: Record<string, Record<string, string | string[]>> = {
      ...
      hi: {
        ...
        s8sub: "पहले तारीख़ चुनें, फिर उपलब्ध समय।",
        ...
        confirmName: "नाम",
        confirmDate: "इंटरव्यू की तारीख़",
        confirmTime: "समय",
        adminLink: "रिक्रूटर व्यू",
        adminTitle: "सभी आवेदन",
        dow: ["रवि", "सोम", "मंगल", "बुध", "गुरु", "शुक्र", "शनि"],
        mon: ["जन", "फ़र", "मार्च", "अप्रै", "मई", "जून", "जुल", "अग", "सित", "अक्टू", "नव", "दिस"],
        noSlotsLine: "अभी कोई तारीख़ नहीं चुनी गई।",
      ...
      <header>
        <div className="brand">
          <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="4" y="20" width="18" height="14" rx="1.5" fill="#FF8A00" />
            <rect x="24" y="14" width="12" height="20" rx="1.5" fill="#FFFFFF" opacity="0.9" />
            <circle cx="12" cy="36" r="4" fill="#FFFFFF" />
            <circle cx="30" cy="36" r="4" fill="#FFFFFF" />
            <rect x="24" y="24" width="14" height="4" fill="#FF8A00" />
          </svg>
          <div className="brand-text" data-i18n="brandName">
            Staff on Time
            <small data-i18n="brandSub">Personaldienstleistung Berlin</small>
          </div>
        </div>
